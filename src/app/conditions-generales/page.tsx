      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-6">
          <div className="prose prose-slate max-w-none">
            ...
            <h2 className={`${garamond.className} mt-12 mb-4 text-3xl font-semibold text-[#D4A373]`}>
              ▸ Article 2 – Objet
            </h2>
            <p className="mb-6">
            ...
            <ul className="mb-6 list-disc space-y-2 pl-6">
              ...
              <li>ni un droit au maintien dans les lieux</li>
            </ul>
            <p className="mb-6">
            ...
            <p className="mb-4">
              La mise à disposition est exclusivement réservée aux professionnels exerçant une activité de consultation, d&apos;accompagnement ou de thérapie non invasive.
            </p>
            ...
            <p className="mb-4">
              L&apos;Exploitant se réserve le droit discrétionnaire d&apos;accepter ou de refuser toute demande de réservation ou d&apos;inscription sans obligation de motivation, dès lors que l&apos;activité déclarée n&apos;est pas compatible avec la destination des lieux.
            </p>
            ...
            <ul className="mb-6 list-disc space-y-2 pl-6">
              ...
              <li>Toute activité générant des nuisances ou des risques spécifiques</li>
            </ul>
            ...
            <h3 className="mt-6 mb-3 text-xl font-semibold">Salon Athéna</h3>
            <ul className="mb-6 list-disc space-y-2 pl-6">
              ...
              <li>Connexion fibre</li>
              <li>Lampe d&apos;appoint</li>
              <li>Récepteur de sonnette d&apos;entrée</li>
              <li>Ouverture de la porte d&apos;entrée depuis la salle de consultation</li>
              <li>Climatisation réversible</li>
              <li>Table de massage sur demande</li>
            </ul>

            <h3 className="mt-6 mb-3 text-xl font-semibold">Salle Gaia</h3>
            <ul className="mb-6 list-disc space-y-2 pl-6">
              <li>Une table de massage et ses accessoires</li>
              <li>Un bureau pliable</li>
              <li>Une chaise</li>
            ...
            <h3 className="mt-6 mb-3 text-xl font-semibold">Grande salle</h3>
            <p className="mb-6">
              Possibilité d&apos;ouverture de la porte coulissante entre les deux salles selon réservation.
            </p>

            <h3 className="mt-6 mb-3 text-xl font-semibold">Espaces communs</h3>
            <ul className="mb-6 list-disc space-y-2 pl-6">
              <li>Salle d&apos;attente</li>
              <li>Cuisine (café, tisane, réfrigérateur, micro-ondes)</li>
              <li>Sanitaires accessibles PMR</li>
              <li>Vestiaire à clé destiné aux affaires personnelles du thérapeute</li>
            </ul>

            <h2 className={`${garamond.className} mt-12 mb-4 text-3xl font-semibold text-[#D4A373]`}>
              ▸ Article 6 – Réservation et paiement
            </h2>
            <p className="mb-4">Le paiement est exigible en totalité lors de la réservation.</p>
            <p className="mb-4">THÉRANICE est exploité par une SCI non assujettie à la TVA.</p>
            <p className="mb-6">Une facture sera émise après règlement.</p>
            ...
            <p className="mb-6">Toute demande d&apos;annulation doit être adressée par écrit.</p>

            <h2 className={`${garamond.className} mt-12 mb-4 text-3xl font-semibold text-[#D4A373]`}>
              ▸ Article 8 – Responsabilité et dégradations
            </h2>
            <p className="mb-4">
              Le professionnel utilisateur est responsable de toute dégradation, détérioration ou disparition de matériel survenant durant sa période d&apos;occupation.
            </p>
            ...
            <p className="mb-6">
              Le professionnel déclare être titulaire d&apos;une assurance Responsabilité Civile Professionnelle couvrant son activité pendant toute la durée d&apos;utilisation des locaux.
            </p>
            ...
            <p className="mb-4">La SCI n&apos;a pas accès aux données personnelles ou de santé des patients.</p>
            <p className="mb-6">
              Le professionnel utilisateur est seul responsable du respect de la réglementation applicable en matière de protection des données.
            </p>
            ...
            <p className="mb-6">
              L&apos;Exploitant se réserve la possibilité de modifier, suspendre ou mettre fin à cet engagement pour des raisons économiques ou organisationnelles, sans que cela puisse engager sa responsabilité.
            </p>
